...
import { Eye, EyeOff, Mail, Lock, GamepadIcon, Zap, Shield } from "lucide-react";
          ...
          <CardHeader className="text-center space-y-6 pb-8 relative z-10">
            ...
            <div>
              ...
              <CardDescription className="text-muted-foreground text-lg">
                Connectez-vous pour rejoindre Los Santos
              </CardDescription>
            </div>
          </CardHeader>
                      ...
                      <FormControl>
                        <div className="relative group">
                          <Input
                            ...
                            className="h-12 bg-secondary/50 border-border/50 backdrop-blur-sm focus:bg-secondary/70 focus:border-primary/50 transition-all duration-300 pl-4 text-foreground placeholder:text-muted-foreground group-hover:shadow-card"
                            {...field}
                          />
                      ...
                      <FormControl>
                        <div className="relative group">
                          <Input
                            ...
                            className="h-12 bg-secondary/50 border-border/50 backdrop-blur-sm focus:bg-secondary/70 focus:border-primary/50 transition-all duration-300 pl-4 pr-12 text-foreground placeholder:text-muted-foreground group-hover:shadow-card"
                            {...field}
                          />
                          <button
                            type="button"
                            onClick={() => setShowPassword(!showPassword)}
                            className="absolute right-3 top-1/2 transform -translate-y-1/2 text-muted-foreground hover:text-primary transition-colors duration-300 p-1"
                          >
            ...
            <div className="space-y-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="bg-gradient-card px-4 text-muted-foreground font-medium">Nouveau joueur ?</span>
                </div>
              </div>
